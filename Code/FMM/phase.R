...
result_scg0_1 <- fitFMM(vData=scg0_matrix[1, 1: 60], nPeriods = 1, nback=4)
result_scg0_2 <- fitFMM(vData=scg0_matrix[1, 61: 120], nPeriods = 1, nback=4)

# result_scg0_2 <- fitFMM(vData=scg0_matrix[1, 63: 122], nPeriods = 1, nback=3)
# result_scg0_2 <- fitFMM(vData=scg0_matrix[1, 126: 185], nPeriods = 1, nback=3)
