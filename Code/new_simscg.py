...
if __name__ == '__main__':
    ...
    for ind in tqdm(range(N)):
        ...
        diastolic = diastolics[ind] #+ systolic
        ...
        data = nk.scg_simulate(duration=duration, sampling_rate=fs, noise=noise, heart_rate=heart_rate, respiratory_rate=respiratory_rate, systolic=systolic, diastolic=diastolic, random_state=random_seed)
